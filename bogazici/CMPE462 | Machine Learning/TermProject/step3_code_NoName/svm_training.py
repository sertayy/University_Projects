...
if __name__ == "__main__":
    ...
    train_path = "/home/umut/Desktop/Projects/CMPE462/Term Project/Step 3/TRAIN"
    val_path = "/home/umut/Desktop/Projects/CMPE462/Term Project/Step 3/VAL"
    ...
    svm_cls = SVC(C=0.01,degree=5, gamma=1, kernel="rbf")
    svm_cls.fit(X_train_new,y_train)

    print("Train Accuracy:\n",accuracy_score(y_train,svm_cls.predict(X_train_new)))
    print("Validation Accuracy:\n",accuracy_score(y_val,svm_cls.predict(X_val_new)))
    print("Train Report:\n",classification_report(y_train,svm_cls.predict(X_train_new)))
    print("Validation Report:\n",classification_report(y_val,svm_cls.predict(X_val_new)))

    plot_confusion_matrix(confusion_matrix(y_train,svm_cls.predict(X_train_new)),confusion_matrix(y_val,svm_cls.predict(X_val_new)))
    plt.show()

    #plt.plot(svm_cls.evals_result()["validation_1"]["merror"][10:])
