...
if __name__ == "__main__":
    ...
    print("Train Accuracy:\n",accuracy_score(y_train,clf.predict(X_train_new)))
    print("Validation Accuracy:\n",accuracy_score(y_val,clf.predict(X_val_new)))
    print("Train Report:\n",classification_report(y_train,clf.predict(X_train_new)))
    print("Validation Report:\n",classification_report(y_val,clf.predict(X_val_new)))

    plot_confusion_matrix(confusion_matrix(y_train,clf.predict(X_train_new)),confusion_matrix(y_val,clf.predict(X_val_new)))
    plt.show()
