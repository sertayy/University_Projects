...
public final class ApplicationConfig {
     ...
     */
    static final String APPLICATION_NAME = ReviewConstants.getApplicationName();

    /**
     * Specify the package name of the app.
     */
    static final String PACKAGE_NAME = ReviewConstants.getPackageName();
     ...
     * </p>
     */
    static final String SERVICE_ACCOUNT_EMAIL = ReviewConstants.getServiceAccountEmail();
}
