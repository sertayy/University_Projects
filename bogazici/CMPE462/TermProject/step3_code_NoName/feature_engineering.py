...
if __name__ == "__main__":
    ...
    X_train_new = np.hstack((
        ...
        np.array(list(train_df["title_embeddings"])),
        ################################################################################
        ...
        train_kmeans_sent,  
        ##################################################################################
        np.vstack((np.array(train_df["pos_score"]),np.array(train_df["neg_score"]),np.array(train_df["diff_score"]))).T,
        np.vstack((np.array(train_df["body_mean"]),np.array(train_df["body_std"]))).T,
    ))
    ...
    X_val_new = np.hstack((
        ...
        np.array(list(val_df["title_embeddings"])),
        ##################################################################################
        ...
        val_kmenas_sent,
        ##################################################################################
        np.vstack((np.array(val_df["pos_score"]),np.array(val_df["neg_score"]),np.array(val_df["diff_score"]))).T,
        np.vstack((np.array(val_df["body_mean"]),np.array(val_df["body_std"]))).T,
    ))
